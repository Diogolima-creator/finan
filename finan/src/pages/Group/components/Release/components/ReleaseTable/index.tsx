...
export const ReleaseTable = ({rows}:Rows) => {
          ...
          >
            ...
            <TableBody>
              {stableSort(rows, getComparator(order, orderBy))
                ...
                .map((row, index) => {
                  const isItemSelected = isSelected((row.date).toString());
                  const labelId = `enhanced-table-checkbox-${index}`;

                  return (
                    <TableRow
                      hover
                      onClick={(event) => handleClick(event, (row.date).toString())}
                      role="checkbox"
                    ...
                    >
                      ...
                      <TableCell align="right">{row.methodOfPayment}</TableCell>
